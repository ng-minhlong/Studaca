...
Urban planners now advocate for several mitigation strategies. These include mandating reflective or "cool" roofing materials, expanding public parks, creating urban forests, and designing wind corridors that allow fresh air to circulate through city centres. Some cities have also introduced permeable paving to allow rainwater to permeate the ground, reducing surface runoff and enabling cooling through evaporation.`,
      questionRanges: [
        {
          label: "1-4",
          description: "Do the following statements agree with the information given in Reading Passage 1?",
          ...
          questions: [
            {
              ...
              number: 1,
              type_question: "multiple-choice",
              question: "Only two Japanese pagodas have collapsed in 1400 years.",
              answers_option: [
                { key: "YES", label: "YES" },
                { key: "NO", label: "NO" },
            ...
            },
            {
              ...
              number: 2,
              type_question: "multiple-choice",
              question: "The Hanshin earthquake of 1995 destroyed the pagoda at the Toji temple.",
              answers_option: [
                { key: "YES", label: "YES" },
                { key: "NO", label: "NO" },
                { key: "NOT GIVEN", label: "NOT GIVEN" },
            ...
            },
            {
              ...
              number: 3,
              type_question: "multiple-choice",
              question: "The other buildings near the Toji pagoda had been built in the last 30 years.",
              answers_option: [
                { key: "YES", label: "YES" },
                { key: "NO", label: "NO" },
                { key: "NOT GIVEN", label: "NOT GIVEN" },
            ...
            },
            {
              ...
              number: 4,
              type_question: "multiple-choice",
              question: "The builders of pagodas knew how to absorb some of the power produced by severe weather conditions.",
              answers_option: [
                { key: "YES", label: "YES" },
                { key: "NO", label: "NO" },
                { key: "NOT GIVEN", label: "NOT GIVEN" },
        ...
        {
          label: "5-10",
          description: "Classify the following as typical of A, B, or C.",
          ...
          questions: [
            {
              ...
              number: 5,
              type_question: "completion",
              question: "easy interior access to top",
              answers_option: [
                { key: "A", label: "A" },
                { key: "B", label: "B" },
                { key: "C", label: "C" },
            ...
            },
            {
              ...
              number: 7,
              type_question: "completion",
              question: "use as observation post",
              answers_option: [
                { key: "A", label: "A" },
                { key: "B", label: "B" },
                { key: "C", label: "C" },
            ...
            },
            {
              ...
              number: 8,
              type_question: "completion",
              question: "size of eaves up to half the width of the building",
              answers_option: [
                { key: "A", label: "A" },
                { key: "B", label: "B" },
                { key: "C", label: "C" },
            ...
            },
            {
              ...
              number: 9,
              type_question: "completion",
              question: "original religious purpose",
              answers_option: [
                { key: "A", label: "A" },
                { key: "B", label: "B" },
                { key: "C", label: "C" },
            ...
            },
            {
              ...
              number: 10,
              type_question: "completion",
              question: "floors fitting loosely over each other",
              answers_option: [
                { key: "A", label: "A" },
                { key: "B", label: "B" },
                { key: "C", label: "C" },
          ...
          questions: [
            {
              ...
              number: 11,
              type_question: "multiple-choice",
              question: "In a Japanese pagoda, the shinbashira",
              answers_option: [
                { key: "A", label: "bears the full weight of the building" },
                { key: "B", label: "bends under pressure like a tree" },
                { key: "C", label: "connects the floors with the foundations" },
                { key: "D", label: "stops the floors moving too far" },
              ],
              correct_answer: "D",
            },
            {
              ...
              number: 12,
              type_question: "multiple-choice",
              question: "Shuzo Ishida performs experiments in order to",
              answers_option: [
                { key: "A", label: "improve skyscraper design" },
                { key: "B", label: "be able to build new pagodas" },
                { key: "C", label: "learn about the dynamics of pagodas" },
                { key: "D", label: "understand ancient mathematics" },
              ],
              correct_answer: "C",
            },
            {
              ...
              number: 13,
              type_question: "multiple-choice",
              question: "The storeys of a Japanese pagoda are",
              answers_option: [
                { key: "A", label: "linked only by wood" },
                { key: "B", label: "fastened only to the central pillar" },
                { key: "C", label: "fitted loosely on top of each other" },
                { key: "D", label: "joined by special weights" },
              ],
              correct_answer: "C",
            },
          ],
  ...
  parts: [
    {
      ...
      questionRanges: [
        {
          label: "Section A",
          description: "Complete the form using no more than two words and/or a number.",
          type_question: "completion",
          questions: [
            {
              id: "lq1",
