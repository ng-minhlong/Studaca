            ...
            >
              ...
              <div className="space-y-0.5">
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant={qr.status === "correct" ? "default" : qr.status === "incorrect" ? "destructive" : "secondary"} className="text-[10px]">
                    {qr.status}
                  </Badge>
                </div>
